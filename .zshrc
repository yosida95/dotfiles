...
plugins=(brew celery coffee django docker git go history-substring-search mercurial npm osx pip python supervisor urltools virtualenv virtualenvwrapper)
