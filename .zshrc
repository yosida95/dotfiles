...
plugins=(brew celery django docker git gitignore go history-substring-search mercurial npm osx pip python sbt scala rbenv supervisor urltools virtualenv)
