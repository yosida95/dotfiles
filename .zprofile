...
GOCODEROOT=/opt/go/gocode
ERLROOT=/opt/erlang/r16b
GHCROOT=/opt/haskell/ghc/7.4
HSPFROOT=/opt/haskell/platform/2012.02.0.0
PBROOT=/opt/protobuf/2.5
export PATH=$PY2ROOT/bin:$PY3ROOT/bin:$GOROOT/bin:$GOCODEROOT/bin:$NODEROOT/bin:$ERLROOT/bin:$GHCROOT/bin:$HSPFROOT/bin:$PBROOT/bin:$HOME/bin:$PATH
